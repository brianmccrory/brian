...
While the [[/v3-0-github][GitHub Pages with Markdown version]] was functional and straightforward, there were some limitations that I was facing. Aside from social media promotion (that I had tried before, and decided to avoid), there was no convenient way to share articles more widely, such as with a newsletter.
...
By moving to Substack with Markdown, I combined the advantages of my Markdown- and Git-based authoring system from [[/v3-0-github/][v3.0]] with the functionality of a Substack newsletter and archive like I had previously used in [[/v2-0-substack][v2.0]].

After restarting the newsletter in May 2023 and importing all previous articles (excluding [[/v3-1-previews][Previews]]), I continued to test new Substack features like newsletter sections, paid subscriptions, and additional newsletters, but I usually came back to my guiding principle of “simpler is better”.
